...
about:
  template: solana
  image: resources/ben_profile.jpg
  links:
    - icon: filetype-pdf
      text: CV
      href: "/resources/cv_Ben_Tournan.pdf"
    - icon: envelope-fill
      text: Contact me
      href: mailto:benjamin.tournan@univ-tlse3.fr
    - icon: twitter
      text: twitter
      href: https://twitter.com/BenjaminTournan
    - icon: link-45deg
      text: ResearchGate
      href: https://www.researchgate.net/profile/Benjamin-Tournan
    - icon: linkedin
      text: LinkedIn
      href: https://www.linkedin.com/in/benjamin-tournan-9450a0154/
---
...
**University Paul Sabatier, Toulouse (France)** <br/>
**Sept 2022 - Present**
